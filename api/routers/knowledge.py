...
async def get_knowledge_graph(session_id: str, manager=Depends(get_session_manager)):
...
async def get_mastery_matrix(session_id: str, manager=Depends(get_session_manager)):
...
async def get_concept_detail(session_id: str, concept_id: str, manager=Depends(get_session_manager)):
