"""Pydantic request/response models for the content-pipeline domain."""

from typing import Literal

from pydantic import BaseModel, Field

from api.schemas.enums import PipelineSessionSource

from .domain.jobs import PipelineStatus
