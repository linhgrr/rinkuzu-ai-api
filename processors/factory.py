...
from processors.errors import LoaderNotFoundError, UnsupportedFormatError
...
class FileLoaderFactory:
    ...
    def _get_chunker(cls, file_type: str):
        ...
        from processors.chunkers import TextChunker
...
def _register_default_loaders():
    ...
    try:
        from processors.loaders.vision_pdf_loader import VisionPDFLoader
