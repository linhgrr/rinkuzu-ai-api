---
name: api
description: "Skill for the Api area of rinkuzu-ai-api. 59 symbols across 15 files."
---

# Api

59 symbols | 15 files | Cohesion: 88%

## When to Use

- Working with code in `api/`
- Understanding how test_count_mastered_concepts_uses_backend_mastery_threshold, is_admin_request, lifespan work
...
| `api/core/shared/s3.py` | get_s3_client |
...
| `get_current_user` | Function | `api/dependencies.py` | 12 |
| `get_app_settings` | Function | `api/dependencies.py` | 30 |
...
| `get_s3_client` | Function | `api/core/shared/s3.py` | 11 |
| `init_mongo` | Function | `api/core/shared/mongo_store.py` | 36 |
| `resolve_llm_api_key` | Function | `api/core/shared/llm.py` | 36 |
